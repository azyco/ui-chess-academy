                            ...
                            <Card bg="light" style={{ marginTop: '1em' }}>
                                <Card.Body>
                                    <Nav variant="pills" className="flex-column" >
                                        <Nav.Item>
                                            <Nav.Link onClick={this.resetState} eventKey="profile">{config.profileTabText}</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link onClick={this.resetState} eventKey="classes">{config.classesTabText}</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link onClick={this.resetState} eventKey="assignments">{config.assignmentsTabText}</Nav.Link>
                                        </Nav.Item>
                                        <Nav.Item>
                                            <Nav.Link onClick={this.resetState} eventKey="puzzles">{config.puzzlesTabText}</Nav.Link>
                                        </Nav.Item>
