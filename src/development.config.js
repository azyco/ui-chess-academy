export default {
    ...
    altContactLabel: 'Whatsapp Number',
    altContactInvalidFeedback: 'Enter a valid Contact Number',
    ...
    imagePlaceholder: 'Upload your photo as a JPG',
    imageInvalidFeedback: "Uploaded file is not a JPG image",
